			...
			if data:
				if (message[0] == 'T1'):
					if rack_type == 1:
						...
						data = b'T1,0,MS3092555-CMF,0,TG2003637-CMF,0,MS3007019-CMF,0,TG2003671-CMF'
					else:
						data = b'T1,0,MS3092555-RMF,0,TG2003637-RMF,0,MS3007019-TMP,0,TG2003671-RMF,0,TG2003667-RMF,0,TG2003626-RMF,0,TG2003657-RMF,0,TG2003660-RMF,0,MS6754129-LMX2,0,TG2003642-RMF,0,MS2929572-AMS1,0,MS6999347-LMX1,0,MS6324325-NULL,0,MS5357075-PW1,0,MS3085936-LPM,0,MS3247197-HP11,0,MS6262931-NULL,0,MS5342413-PW1,0,TG2003635-RMF,0,TG2003630-RMF,0,MS3040982-HP12'
				elif (message[0] == 'R0'):
					data = b'R0'
				elif (message[0][:2] == 'PW'):
					if message[2]=='2':
